...
// Contract represents a cw-ibc-lite-ics20-transfer contract on a Chain.
type Contract = types.Contract[InstantiateMsg, ExecuteMsg, QueryMsg, QueryClient]

// Instantiate creates a new cw-ibc-lite-ics20-transfer contract instance on the chain.
