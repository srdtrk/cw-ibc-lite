...
type QueryClient interface {
	// PortRouter is the client API for the QueryMsg_PortRouter query message
	PortRouter(ctx context.Context, req *QueryMsg_PortRouter, opts ...grpc.CallOption) (*string, error)
}
...
func (q *queryClient) PortRouter(ctx context.Context, req *QueryMsg_PortRouter, opts ...grpc.CallOption) (*string, error) {
	rawQueryData, err := json.Marshal(&QueryMsg{PortRouter: req})
	if err != nil {
		return nil, err
	}
