...
// Contract represents a cw-ibc-lite-ics07-tendermint contract on a Chain.
type Contract = types.Contract[InstantiateMsg, ExecuteMsg, QueryMsg, QueryClient]

// Instantiate creates a new cw-ibc-lite-ics07-tendermint contract instance on the chain.
